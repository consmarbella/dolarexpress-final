          ...
          <article>
            ...
            <div className="grid md:grid-cols-3 gap-6 my-12">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <p className="text-sm">Coordinamos la operación por WhatsApp. Tú autorizas la compra directamente desde tu tarjeta.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="mb-6">
              Entendemos que la seguridad es fundamental. Al realizar la <strong>venta de tu cupo en dólares</strong> con nosotros, operas bajo un modelo transparente y legal. Nunca almacenamos los códigos de seguridad de tu tarjeta. Evita riesgos informales y opera con expertos en transacciones digitales.
            </p>
          </article>
        </div>
      </main>
