...
export const pseoPages: PSEOPageData[] = [
  ...
  },
  {
    ...
    title: 'Avance Cupo Dolares | DolarExpress',
    description: 'Especialistas en compra y venta de cupo en dólares. Transferencia inmediata, segura y rápida.'
  },
  {
  ...
  },
  {
    ...
    title: 'Cupo En Dolares | DolarExpress',
    description: 'Especialistas en compra y venta de cupo en dólares. Transferencia inmediata, segura y rápida.'
  },
  {
  ...
  },
  {
    ...
    title: 'Vender Cupo Dolar | DolarExpress',
    description: 'Especialistas en compra y venta de cupo en dólares. Transferencia inmediata, segura y rápida.'
  },
  {
  ...
  // === CLUSTER 1: PRÉSTAMO CON TARJETA por marca ===
  { slug: 'prestamo-con-tarjeta-lider', title: 'Préstamo con Tarjeta Líder | DolarExpress', description: 'Convertí el cupo de tu tarjeta Líder en efectivo hoy. Sin avance habilitado, sin revisar DICOM. Transferencia a tu cuenta en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-con-tarjeta-cmr', title: 'Préstamo con Tarjeta CMR Falabella | DolarExpress', description: 'Usá el cupo de compras de tu CMR Falabella para obtener efectivo hoy. Sin avance, sin banco, sin papeleos. Te transferimos en menos de 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-ripley', title: 'Préstamo con Tarjeta Ripley | DolarExpress', description: 'Transformá el cupo de tu Tarjeta Ripley en pesos chilenos hoy. Proceso express por WhatsApp, sin requisitos bancarios. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-paris', title: 'Préstamo con Tarjeta Paris | DolarExpress', description: 'Convertí tu cupo Paris Cencosud en efectivo al instante. Sin avance requerido, sin DICOM. Todo por WhatsApp, transferencia en 15 minutos a tu cuenta.' },
  { slug: 'prestamo-con-tarjeta-la-polar', title: 'Préstamo con Tarjeta La Polar | DolarExpress', description: 'Obtenés efectivo usando el cupo de tu Tarjeta La Polar. Sin revisar historial crediticio. Transferencia en 15 minutos vía WhatsApp, sin ir a sucursales.' },
  { slug: 'prestamo-con-tarjeta-hites', title: 'Préstamo con Tarjeta Hites | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Hites en efectivo hoy mismo. Sin avance habilitado, sin DICOM, sin garante. Contactanos por WhatsApp y recibís en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-abcdin', title: 'Préstamo con Tarjeta ABCDin | DolarExpress', description: 'Transformá el cupo de tu Tarjeta ABCDin en pesos chilenos. Sin avance necesario, sin banco. Operación 100% online por WhatsApp en menos de 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-cencosud', title: 'Préstamo con Tarjeta Cencosud | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Cencosud en efectivo al instante. Sin revisar DICOM ni pedir documentos. Transferencia en 15 minutos, proceso 100% online.' },
  { slug: 'prestamo-con-tarjeta-johnson', title: 'Préstamo con Tarjeta Johnson | DolarExpress', description: 'Usá el cupo de tu Tarjeta Johnson para obtener efectivo hoy. Sin avance, sin historial crediticio. Contactanos por WhatsApp y recibís en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-easy', title: 'Préstamo con Tarjeta Easy Cencosud | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Easy en pesos chilenos hoy. Sin avance habilitado requerido. Proceso express por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-jumbo', title: 'Préstamo con Tarjeta Jumbo Cencosud | DolarExpress', description: 'Transformá el cupo de tu Tarjeta Jumbo en efectivo al instante. Sin DICOM, sin papeleos. Operación 100% online, transferencia en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-con-tarjeta-corona', title: 'Préstamo con Tarjeta Corona | DolarExpress', description: 'Obtenés plata usando el cupo de tu Tarjeta Corona. Sin avance necesario, sin revisar historial. Todo por WhatsApp, transferencia en menos de 15 minutos.' },

  // === CLUSTER 1: PRÉSTAMO + SIN DICOM por marca ===
  { slug: 'prestamo-tarjeta-lider-sin-dicom', title: 'Préstamo Tarjeta Líder Sin Dicom | DolarExpress', description: 'Tenés Tarjeta Líder y estás en DICOM? No importa. Solo necesitás cupo disponible. Te damos efectivo sin revisar tu historial. Transferencia en 15 minutos.' },
  { slug: 'prestamo-tarjeta-cmr-sin-dicom', title: 'Préstamo Tarjeta CMR Sin Dicom | DolarExpress', description: 'Con tarjeta CMR Falabella obtenés efectivo sin que te revisen el DICOM. Solo necesitás cupo disponible. Proceso por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'prestamo-tarjeta-ripley-sin-dicom', title: 'Préstamo Tarjeta Ripley Sin Dicom | DolarExpress', description: 'Usá tu Tarjeta Ripley para obtener efectivo sin revisión de DICOM. Solo cupo disponible y listo. Transferencia en 15 minutos, operación 100% online.' },
  { slug: 'prestamo-tarjeta-paris-sin-dicom', title: 'Préstamo Tarjeta Paris Sin Dicom | DolarExpress', description: 'Tarjeta Paris con cupo disponible? Te damos efectivo sin revisar DICOM ni historial crediticio. Proceso rápido por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'prestamo-tarjeta-la-polar-sin-dicom', title: 'Préstamo Tarjeta La Polar Sin Dicom | DolarExpress', description: 'Con Tu Tarjeta La Polar accedés a efectivo sin DICOM. No revisamos tu historial. Solo necesitás cupo disponible. Transferencia en 15 minutos.' },
  { slug: 'prestamo-tarjeta-hites-sin-dicom', title: 'Préstamo Tarjeta Hites Sin Dicom | DolarExpress', description: 'Tarjeta Hites con cupo? Te damos efectivo sin revisar el DICOM. Sin garante, sin liquidaciones, sin banco. Contactanos por WhatsApp y recibís en 15 minutos.' },
  { slug: 'prestamo-tarjeta-abcdin-sin-dicom', title: 'Préstamo Tarjeta ABCDin Sin Dicom | DolarExpress', description: 'Convertí el cupo de tu Tarjeta ABCDin en efectivo sin que te revisen el DICOM. Solo necesitás cupo disponible. Operación express en menos de 15 minutos.' },
  { slug: 'prestamo-tarjeta-cencosud-sin-dicom', title: 'Préstamo Tarjeta Cencosud Sin Dicom | DolarExpress', description: 'Tarjeta Cencosud con cupo disponible? Accedés a efectivo sin revisión de DICOM ni historial. Proceso 100% online, transferencia a tu cuenta en 15 minutos.' },

  // === CLUSTER 1: URGENTE / ONLINE por marca ===
  { slug: 'prestamo-tarjeta-lider-urgente', title: 'Préstamo Urgente Tarjeta Líder | DolarExpress', description: 'Necesitás plata urgente y tenés Tarjeta Líder con cupo? Te transferimos en menos de 15 minutos. Proceso express por WhatsApp sin filas ni trámites.' },
  { slug: 'prestamo-tarjeta-cmr-urgente', title: 'Préstamo Urgente Tarjeta CMR | DolarExpress', description: 'Plata urgente con tu CMR Falabella. Desde que nos escribís hasta que recibís la transferencia: menos de 15 minutos. Sin papeleos, sin revisión de DICOM.' },
  { slug: 'prestamo-tarjeta-ripley-urgente', title: 'Préstamo Urgente Tarjeta Ripley | DolarExpress', description: 'Efectivo urgente usando el cupo de tu Tarjeta Ripley. Operamos todos los días incluyendo feriados. Transferencia en 15 minutos por WhatsApp, sin burocracia.' },
  { slug: 'prestamo-tarjeta-paris-urgente', title: 'Préstamo Urgente Tarjeta Paris | DolarExpress', description: 'Necesitás efectivo urgente y tenés Tarjeta Paris con cupo? Te solucionamos en 15 minutos. Proceso 100% por WhatsApp, sin ir a ninguna sucursal.' },
  { slug: 'prestamo-tarjeta-la-polar-urgente', title: 'Préstamo Urgente Tarjeta La Polar | DolarExpress', description: 'Efectivo urgente con tu Tarjeta La Polar. Sin avance habilitado, sin DICOM, sin garante. Escribinos por WhatsApp y recibís la transferencia en 15 minutos.' },
  { slug: 'prestamo-tarjeta-lider-online', title: 'Préstamo Online Tarjeta Líder | DolarExpress', description: 'Convertí tu cupo Líder en efectivo 100% online. Sin salir de tu casa, sin filas, sin sucursales. Todo por WhatsApp, transferencia a tu cuenta en 15 minutos.' },
  { slug: 'prestamo-tarjeta-cmr-online', title: 'Préstamo Online Tarjeta CMR Falabella | DolarExpress', description: 'Obtenés efectivo con tu CMR Falabella totalmente online. Sin ir al banco ni a la tienda. Proceso completo por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'prestamo-tarjeta-ripley-online', title: 'Préstamo Online Tarjeta Ripley | DolarExpress', description: 'Usá tu Tarjeta Ripley para obtener efectivo 100% online. Sin documentos físicos, sin sucursales. Proceso por WhatsApp, dinero en tu cuenta en 15 minutos.' },
  { slug: 'prestamo-tarjeta-paris-online', title: 'Préstamo Online Tarjeta Paris | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Paris en pesos online. Sin trámites presenciales, sin horarios de atención limitados. Transferencia en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-tarjeta-la-polar-online', title: 'Préstamo Online Tarjeta La Polar | DolarExpress', description: 'Obtenés efectivo con tu Tarjeta La Polar completamente online. Sin ir a ningún lado, sin filas. Todo por WhatsApp, transferencia a tu cuenta en 15 minutos.' },
  { slug: 'prestamo-tarjeta-hites-online', title: 'Préstamo Online Tarjeta Hites | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Hites en efectivo de forma 100% online. Sin burocracia, sin sucursales. Proceso por WhatsApp, dinero en tu cuenta en minutos.' },

  // === GENÉRICOS RETAIL ===
  { slug: 'prestamo-con-tarjeta-de-tienda', title: 'Préstamo con Tarjeta de Tienda | DolarExpress', description: 'Convertí el cupo de compras de tu tarjeta de grandes tiendas en efectivo. CMR, Ripley, Paris, La Polar, Hites y más. Transferencia en 15 minutos, sin DICOM.' },
  { slug: 'prestamo-con-tarjeta-retail', title: 'Préstamo con Tarjeta Retail | DolarExpress', description: 'Usá el cupo de tu tarjeta retail para obtener efectivo hoy. Trabajamos con todas las tarjetas de grandes tiendas de Chile. Sin banco, sin DICOM, en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-retail-sin-dicom', title: 'Préstamo con Tarjeta Retail Sin Dicom | DolarExpress', description: 'Obtenés efectivo con tu tarjeta retail sin que te revisen el DICOM. Solo necesitás cupo disponible. CMR, Ripley, La Polar, Hites y más. Transferencia en 15 min.' },
  { slug: 'prestamo-con-tarjeta-retail-urgente', title: 'Préstamo Urgente con Tarjeta Retail | DolarExpress', description: 'Plata urgente usando el cupo de tu tarjeta retail. Proceso express por WhatsApp, transferencia en menos de 15 minutos. Operamos todos los días, feriados incluidos.' },
  { slug: 'prestamo-con-tarjeta-retail-online', title: 'Préstamo Online con Tarjeta Retail | DolarExpress', description: 'Convertí tu cupo retail en efectivo 100% online. Sin sucursales ni trámites presenciales. CMR, Ripley, Paris, La Polar, Hites y más. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-casa-comercial', title: 'Préstamo con Tarjeta Casa Comercial | DolarExpress', description: 'Transformá el cupo de tu tarjeta de casa comercial en efectivo. Todas las marcas: Falabella, Ripley, La Polar, Hites, ABCDin y más. Sin banco, en 15 minutos.' },
  { slug: 'prestamo-con-tarjeta-grandes-tiendas', title: 'Préstamo con Tarjeta Grandes Tiendas Chile | DolarExpress', description: 'Convertí el cupo de tu tarjeta de grandes tiendas en pesos chilenos. Sin avance habilitado requerido. Proceso 100% online, transferencia en 15 minutos.' },
  { slug: 'prestamo-solo-con-tarjeta-de-tienda', title: 'Préstamo Solo con Tarjeta de Tienda | DolarExpress', description: 'Solo necesitás tu tarjeta de tienda con cupo disponible. Sin documentos, sin banco, sin DICOM. Convertimos tu cupo en efectivo en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-usando-tarjeta-retail', title: 'Préstamo Usando Tarjeta Retail | DolarExpress', description: 'Obtén un préstamo informal usando el cupo de tu tarjeta retail como garantía. Sin avance, sin historial. Trabajamos con todas las grandes tiendas de Chile.' },

  // === CLUSTER 2: CRÉDITO CON TARJETA ===
  { slug: 'credito-con-tarjeta-de-tienda', title: 'Crédito con Tarjeta de Tienda | DolarExpress', description: 'Accedés a crédito sin banco usando el cupo de tu tarjeta de grandes tiendas. Sin evaluación crediticia, sin DICOM. Efectivo en tu cuenta en 15 minutos.' },
  { slug: 'credito-con-tarjeta-lider', title: 'Crédito con Tarjeta Líder | DolarExpress', description: 'Tu Tarjeta Líder como acceso a crédito informal. Sin banco, sin DICOM, sin garante. Convertimos tu cupo en efectivo en 15 minutos. Alternativa real al banco.' },
  { slug: 'credito-con-tarjeta-cmr', title: 'Crédito con Tarjeta CMR Falabella | DolarExpress', description: 'Obtenés crédito alternativo usando tu CMR Falabella. Sin evaluación bancaria ni DICOM. Transformamos tu cupo en pesos en menos de 15 minutos por WhatsApp.' },
  { slug: 'credito-con-tarjeta-ripley', title: 'Crédito con Tarjeta Ripley | DolarExpress', description: 'Tu Tarjeta Ripley como fuente de crédito sin pasar por el banco. Sin DICOM, sin liquidaciones. Convertimos tu cupo en efectivo en 15 minutos, 100% online.' },
  { slug: 'credito-con-tarjeta-paris', title: 'Crédito con Tarjeta Paris | DolarExpress', description: 'Accedés a crédito informal usando el cupo de tu Tarjeta Paris. Sin historial crediticio, sin banco. Efectivo en tu cuenta en 15 minutos por WhatsApp.' },
  { slug: 'credito-con-tarjeta-la-polar', title: 'Crédito con Tarjeta La Polar | DolarExpress', description: 'Tu Tarjeta La Polar te abre las puertas a crédito sin banco. Sin DICOM, sin aval. DolarExpress convierte tu cupo en efectivo en menos de 15 minutos.' },
  { slug: 'credito-con-tarjeta-hites', title: 'Crédito con Tarjeta Hites | DolarExpress', description: 'Convertí tu cupo Hites en crédito efectivo sin pasar por el sistema bancario. Sin evaluación crediticia, sin DICOM. Transferencia en 15 minutos, 100% online.' },
  { slug: 'credito-con-tarjeta-cencosud', title: 'Crédito con Tarjeta Cencosud | DolarExpress', description: 'Tu Tarjeta Cencosud como acceso a crédito alternativo. Sin banco, sin DICOM, sin garante. Convertimos tu cupo en efectivo en 15 minutos. Proceso por WhatsApp.' },
  { slug: 'credito-con-tarjeta-retail-sin-dicom', title: 'Crédito con Tarjeta Retail Sin Dicom | DolarExpress', description: 'Obtenés crédito usando tu tarjeta retail sin que te revisen el DICOM. Cualquier tarjeta de grandes tiendas con cupo disponible. Efectivo en 15 minutos.' },
  { slug: 'credito-rapido-con-tarjeta-de-tienda', title: 'Crédito Rápido con Tarjeta de Tienda | DolarExpress', description: 'El crédito más rápido del mercado: usamos el cupo de tu tarjeta de grandes tiendas. Sin banco, sin papeleos, sin DICOM. Transferencia en menos de 15 minutos.' },
  { slug: 'credito-rapido-tarjeta-retail', title: 'Crédito Rápido con Tarjeta Retail | DolarExpress', description: 'Crédito rápido sin banco usando tu tarjeta retail. CMR, Ripley, Paris, La Polar, Hites, Líder y más. Sin DICOM, sin liquidaciones. Efectivo en 15 minutos.' },
  { slug: 'credito-online-tarjeta-de-tienda', title: 'Crédito Online con Tarjeta de Tienda | DolarExpress', description: 'Crédito 100% online usando el cupo de tu tarjeta de tienda. Sin ir a sucursales, sin trámites presenciales. Proceso por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'credito-sin-banco-con-tarjeta', title: 'Crédito Sin Banco con Tarjeta de Tienda | DolarExpress', description: 'Accedés a crédito sin necesitar banco. Solo tu tarjeta de grandes tiendas con cupo disponible. Sin DICOM, sin cuenta corriente, sin garante. En 15 minutos.' },

  // === CLUSTER 3: PRÉSTAMO CON CUPO DE COMPRAS ===
  { slug: 'prestamo-con-cupo-de-compras', title: 'Préstamo con Cupo de Compras | DolarExpress', description: 'Tu cupo de compras puede convertirse en efectivo hoy. DolarExpress transforma el cupo de cualquier tarjeta de grandes tiendas en pesos chilenos en 15 minutos.' },
  { slug: 'prestamo-con-cupo-de-compras-lider', title: 'Préstamo con Cupo de Compras Líder | DolarExpress', description: 'Convertí el cupo de compras de tu Tarjeta Líder en efectivo. No es avance: es diferente y más fácil. Sin habilitación especial. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-cupo-de-compras-cmr', title: 'Préstamo con Cupo de Compras CMR | DolarExpress', description: 'El cupo de compras de tu CMR Falabella puede ser efectivo hoy. Sin avance habilitado, sin DICOM. DolarExpress hace la conversión en menos de 15 minutos.' },
  { slug: 'prestamo-con-cupo-de-compras-ripley', title: 'Préstamo con Cupo de Compras Ripley | DolarExpress', description: 'Transformá el cupo de compras de tu Tarjeta Ripley en pesos chilenos. No requiere avance habilitado. Proceso 100% online por WhatsApp, transferencia en 15 min.' },
  { slug: 'prestamo-con-cupo-de-compras-paris', title: 'Préstamo con Cupo de Compras Paris | DolarExpress', description: 'Tu cupo de compras Paris Cencosud puede ser efectivo al instante. Sin necesidad de avance ni habilitaciones especiales. DolarExpress lo convierte en 15 minutos.' },
  { slug: 'prestamo-con-cupo-de-compras-la-polar', title: 'Préstamo con Cupo de Compras La Polar | DolarExpress', description: 'El cupo de compras de tu Tarjeta La Polar vale más de lo que creés. Convertilo en efectivo hoy sin avance, sin DICOM, sin garante. En 15 minutos.' },
  { slug: 'prestamo-con-cupo-de-compras-hites', title: 'Préstamo con Cupo de Compras Hites | DolarExpress', description: 'Convertí el cupo de compras de tu Tarjeta Hites en efectivo. Proceso diferente al avance, más accesible. Sin DICOM, sin papeleos. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-cupo-de-compras-cencosud', title: 'Préstamo con Cupo de Compras Cencosud | DolarExpress', description: 'Tu cupo de compras Cencosud puede transformarse en efectivo hoy. DolarExpress hace la conversión sin avance habilitado, sin DICOM. En menos de 15 minutos.' },
  { slug: 'usar-cupo-de-compras-como-prestamo', title: 'Usar Cupo de Compras como Préstamo | DolarExpress', description: 'Tu cupo de compras puede funcionar como un préstamo informal. DolarExpress convierte el cupo de cualquier tarjeta retail en efectivo. Sin banco, en 15 minutos.' },
  { slug: 'cupo-de-compras-como-prestamo-personal', title: 'Cupo de Compras como Préstamo Personal | DolarExpress', description: 'Usá el cupo de compras de tu tarjeta de tienda como un préstamo personal. CMR, Ripley, La Polar y más. Sin banco, sin DICOM. Efectivo en tu cuenta en 15 min.' },

  // === CLUSTER 4: SIN DICOM ===
  { slug: 'prestamo-sin-dicom-con-tarjeta', title: 'Préstamo Sin Dicom con Tarjeta de Tienda | DolarExpress', description: 'Obtenés efectivo sin que te revisen el DICOM. Solo tu tarjeta de grandes tiendas con cupo. Sin historial crediticio, sin banco. Transferencia en 15 minutos.' },
  { slug: 'prestamo-sin-dicom-solo-con-tarjeta', title: 'Préstamo Sin Dicom Solo con Tarjeta | DolarExpress', description: 'Solo necesitás tu tarjeta con cupo para obtener efectivo sin DICOM. Sin liquidaciones, sin garante, sin cuenta corriente. DolarExpress te transfiere en 15 min.' },
  { slug: 'prestamo-sin-dicom-tarjeta-de-tienda', title: 'Préstamo Sin Dicom con Tarjeta de Grandes Tiendas | DolarExpress', description: 'Préstamo sin revisión de DICOM usando tu tarjeta de grandes tiendas. CMR, Ripley, Paris, La Polar, Líder, Hites y más. Solo cupo disponible. En 15 minutos.' },
  { slug: 'prestamo-sin-dicom-online-tarjeta', title: 'Préstamo Sin Dicom Online con Tarjeta | DolarExpress', description: 'Obtenés préstamo sin DICOM de forma 100% online usando tu tarjeta retail. Sin ir a sucursales, sin documentos. Proceso por WhatsApp, transferencia en 15 min.' },
  { slug: 'credito-sin-dicom-con-tarjeta-de-tienda', title: 'Crédito Sin Dicom con Tarjeta de Tienda | DolarExpress', description: 'Accedés a crédito sin revisión de DICOM usando tu tarjeta de grandes tiendas. Solo necesitás cupo disponible. Sin papeleos, sin banco. En menos de 15 minutos.' },
  { slug: 'efectivo-sin-dicom-con-tarjeta-retail', title: 'Efectivo Sin Dicom con Tarjeta Retail | DolarExpress', description: 'Obtenés efectivo sin DICOM usando el cupo de tu tarjeta retail. Sin historial crediticio, sin banco, sin garante. Proceso 100% online, transferencia en 15 min.' },
  { slug: 'plata-sin-dicom-tarjeta-de-tienda', title: 'Plata Sin Dicom con Tarjeta de Tienda | DolarExpress', description: 'Conseguís plata sin que te revisen el DICOM. Solo tu tarjeta de tienda con cupo disponible. Sin requisitos bancarios. Escribinos por WhatsApp, en 15 minutos.' },

  // === CLUSTER 5: SIN REQUISITOS ===
  { slug: 'prestamo-sin-liquidaciones-tarjeta-de-tienda', title: 'Préstamo Sin Liquidaciones con Tarjeta de Tienda | DolarExpress', description: 'No pedimos liquidaciones de sueldo. Solo tu tarjeta de grandes tiendas con cupo. Sin documentos laborales, sin banco. Efectivo en tu cuenta en 15 minutos.' },
  { slug: 'prestamo-sin-cotizaciones-tarjeta', title: 'Préstamo Sin Cotizaciones AFP con Tarjeta | DolarExpress', description: 'Sin cotizaciones AFP ni comprobantes de renta. Solo cupo en tu tarjeta de tienda. Ideal para trabajadores informales o independientes. Transferencia en 15 min.' },
  { slug: 'prestamo-sin-cuenta-corriente-tarjeta-retail', title: 'Préstamo Sin Cuenta Corriente con Tarjeta Retail | DolarExpress', description: 'No necesitás cuenta corriente para obtener efectivo. Tu tarjeta retail con cupo disponible es suficiente. Transferimos a CuentaRUT también. En 15 minutos.' },
  { slug: 'prestamo-sin-aval-con-tarjeta', title: 'Préstamo Sin Aval con Tarjeta de Tienda | DolarExpress', description: 'Sin aval, sin codeudor, sin fiador. Solo tu tarjeta de grandes tiendas con cupo disponible. DolarExpress te da efectivo sin necesitar a nadie más. En 15 minutos.' },
  { slug: 'prestamo-sin-garante-tarjeta-de-tienda', title: 'Préstamo Sin Garante con Tarjeta de Tienda | DolarExpress', description: 'No necesitás garante ni co-firmante. Solo tu tarjeta retail con cupo. Sin banco, sin DICOM, sin aval. DolarExpress te transfiere el efectivo en menos de 15 min.' },
  { slug: 'prestamo-sin-contrato-de-trabajo-tarjeta', title: 'Préstamo Sin Contrato de Trabajo con Tarjeta | DolarExpress', description: 'Sin contrato de trabajo ni boleta de empleador. Solo cupo en tu tarjeta de tienda. Ideal para trabajadores por cuenta propia. Efectivo en tu cuenta en 15 min.' },
  { slug: 'prestamo-sin-boleta-honorarios-tarjeta', title: 'Préstamo Sin Boleta de Honorarios con Tarjeta | DolarExpress', description: 'Sin boletas de honorarios ni comprobantes de ingresos. Solo tu tarjeta de grandes tiendas con cupo. Sin papeleos, sin banco. Transferencia en 15 minutos.' },
  { slug: 'prestamo-sin-acreditar-renta-tarjeta', title: 'Préstamo Sin Acreditar Renta con Tarjeta | DolarExpress', description: 'No tenés que acreditar renta ni ingresos. Solo cupo disponible en tu tarjeta retail. Sin comprobantes, sin banco. DolarExpress te transfiere en 15 minutos.' },
  { slug: 'prestamo-solo-con-rut-y-tarjeta', title: 'Préstamo Solo con RUT y Tarjeta de Tienda | DolarExpress', description: 'Solo necesitás tu RUT y tu tarjeta de grandes tiendas con cupo. Sin más documentos, sin banco, sin DICOM. El proceso más simple del mercado. En 15 minutos.' },
  { slug: 'prestamo-sin-banco-con-tarjeta-tienda', title: 'Préstamo Sin Banco con Tarjeta de Tienda | DolarExpress', description: 'Obtenés efectivo sin pasar por ningún banco. Tu tarjeta de grandes tiendas con cupo es tu acceso directo. Sin evaluación bancaria, sin DICOM. En 15 minutos.' },
  { slug: 'credito-sin-requisitos-tarjeta-retail', title: 'Crédito Sin Requisitos con Tarjeta Retail | DolarExpress', description: 'El crédito más accesible del mercado: sin liquidaciones, sin garante, sin DICOM, sin cuenta corriente. Solo tu tarjeta retail con cupo. Efectivo en 15 minutos.' },
  { slug: 'efectivo-sin-papeleos-tarjeta', title: 'Efectivo Sin Papeleos con Tarjeta de Tienda | DolarExpress', description: 'Sin papeleos, sin trámites, sin documentos. Solo tu tarjeta de grandes tiendas con cupo disponible. DolarExpress te transfiere el efectivo en menos de 15 minutos.' },

  // === CLUSTER 6: SITUACIÓN DEL USUARIO ===
  { slug: 'necesito-prestamo-y-solo-tengo-tarjeta-de-tienda', title: 'Solo Tengo Tarjeta de Tienda y Necesito Préstamo | DolarExpress', description: 'Si solo tenés una tarjeta de grandes tiendas, eso es suficiente. DolarExpress convierte tu cupo en efectivo hoy. Sin banco, sin DICOM. Contactanos por WhatsApp.' },
  { slug: 'necesito-plata-y-tengo-cupo-lider', title: 'Necesito Plata y Tengo Cupo en Tarjeta Líder | DolarExpress', description: 'Si tenés cupo en tu Tarjeta Líder y necesitás plata hoy, DolarExpress es tu solución. Convertimos ese cupo en efectivo en 15 minutos. Sin banco, sin DICOM.' },
  { slug: 'necesito-plata-y-tengo-cupo-paris', title: 'Necesito Plata y Tengo Cupo en Tarjeta Paris | DolarExpress', description: 'Tenés cupo disponible en tu Tarjeta Paris y necesitás efectivo? DolarExpress lo convierte en pesos en 15 minutos. Sin avance habilitado, sin DICOM, sin papeleos.' },
  { slug: 'necesito-plata-y-tengo-cupo-hites', title: 'Necesito Plata y Tengo Cupo en Tarjeta Hites | DolarExpress', description: 'Tu cupo Hites puede ser efectivo hoy. Si necesitás plata y tenés cupo disponible en tu Tarjeta Hites, DolarExpress te transfiere en 15 minutos por WhatsApp.' },
  { slug: 'necesito-plata-y-tengo-cupo-la-polar', title: 'Necesito Plata y Tengo Cupo en Tarjeta La Polar | DolarExpress', description: 'Cupo disponible en tu Tarjeta La Polar? DolarExpress lo convierte en efectivo hoy. Sin avance, sin DICOM, sin garante. Transferencia en 15 minutos por WhatsApp.' },
  { slug: 'necesito-plata-y-tengo-cupo-abcdin', title: 'Necesito Plata y Tengo Cupo en Tarjeta ABCDin | DolarExpress', description: 'Si tenés cupo en tu Tarjeta ABCDin y necesitás efectivo ahora, DolarExpress es la respuesta. Convertimos tu cupo en pesos en 15 minutos. Sin banco, sin DICOM.' },
  { slug: 'necesito-plata-y-tengo-cupo-cencosud', title: 'Necesito Plata y Tengo Cupo en Tarjeta Cencosud | DolarExpress', description: 'Cupo disponible en tu Tarjeta Cencosud y necesitás efectivo? DolarExpress lo transforma en pesos chilenos en 15 minutos. Sin avance, sin DICOM, sin papeleos.' },
  { slug: 'tengo-cupo-en-tarjeta-y-necesito-efectivo', title: 'Tengo Cupo en Tarjeta y Necesito Efectivo | DolarExpress', description: 'Tu cupo de tarjeta de tienda puede convertirse en efectivo hoy mismo. DolarExpress compra tu cupo y te transfiere en 15 minutos. Sin banco ni DICOM.' },
  { slug: 'tengo-cupo-en-tarjeta-lider-necesito-plata', title: 'Tengo Cupo en Tarjeta Líder y Necesito Plata | DolarExpress', description: 'Tu cupo Líder es plata disponible. DolarExpress lo convierte en efectivo en 15 minutos. Sin avance habilitado, sin DICOM, sin papeleos. Solo WhatsApp.' },
  { slug: 'tengo-cupo-en-cmr-y-necesito-dinero', title: 'Tengo Cupo en CMR y Necesito Dinero | DolarExpress', description: 'Tu cupo CMR Falabella puede ser efectivo hoy. DolarExpress lo convierte en pesos en 15 minutos. Sin avance, sin DICOM, sin liquidaciones. Solo por WhatsApp.' },
  { slug: 'tengo-cupo-en-ripley-y-necesito-efectivo', title: 'Tengo Cupo en Ripley y Necesito Efectivo | DolarExpress', description: 'El cupo de tu Tarjeta Ripley puede ser efectivo al instante. DolarExpress hace la conversión en 15 minutos. Sin avance habilitado, sin DICOM, sin trámites.' },
  { slug: 'tengo-cupo-en-paris-y-necesito-plata', title: 'Tengo Cupo en Paris y Necesito Plata | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Paris en plata hoy. DolarExpress te transfiere en 15 minutos. Sin necesidad de avance, sin DICOM, sin ir a ningún banco.' },
  { slug: 'tengo-cupo-en-la-polar-y-necesito-efectivo', title: 'Tengo Cupo en La Polar y Necesito Efectivo | DolarExpress', description: 'Tu cupo La Polar puede transformarse en efectivo hoy mismo. DolarExpress lo convierte en pesos en 15 minutos por WhatsApp. Sin avance, sin DICOM.' },
  { slug: 'tengo-cupo-en-hites-y-necesito-plata', title: 'Tengo Cupo en Hites y Necesito Plata | DolarExpress', description: 'El cupo de tu Tarjeta Hites es plata disponible. DolarExpress lo convierte en efectivo en 15 minutos. Sin avance habilitado, sin DICOM, sin banco ni trámites.' },
  { slug: 'estoy-en-dicom-y-tengo-tarjeta-de-tienda', title: 'Estoy en DICOM y Tengo Tarjeta de Tienda | DolarExpress', description: 'Estás en DICOM y tenés una tarjeta de grandes tiendas con cupo? DolarExpress no revisa el DICOM. Solo necesitás cupo disponible. Transferencia en 15 minutos.' },
  { slug: 'no-me-dan-credito-en-el-banco-tengo-tarjeta', title: 'No Me Dan Crédito en el Banco Pero Tengo Tarjeta de Tienda | DolarExpress', description: 'Si el banco te rechazó pero tenés tarjeta de grandes tiendas con cupo, DolarExpress tiene la solución. Sin evaluación bancaria. Efectivo en 15 minutos.' },
  { slug: 'no-me-aprueban-prestamo-pero-tengo-tarjeta', title: 'No Me Aprueban Préstamo Pero Tengo Tarjeta de Tienda | DolarExpress', description: 'Rechazado en el sistema bancario? Si tenés tarjeta retail con cupo disponible, DolarExpress te da efectivo. Sin DICOM, sin historial. Transferencia en 15 min.' },
  { slug: 'tengo-cupo-pero-no-avance-habilitado', title: 'Tengo Cupo Pero No Tengo Avance Habilitado | DolarExpress', description: 'Tu tarjeta tiene cupo pero no avance habilitado? DolarExpress usa ese cupo de compras para darte efectivo. Sin necesitar avance. Transferencia en 15 minutos.' },

  // === CLUSTER 7: EFECTIVO URGENTE / PLATA RÁPIDA ===
  { slug: 'plata-rapida-tarjeta-lider', title: 'Plata Rápida con Tarjeta Líder | DolarExpress', description: 'Obtenés plata rápida usando el cupo de tu Tarjeta Líder. Desde que nos contactás hasta que recibís la transferencia: menos de 15 minutos. Sin trámites.' },
  { slug: 'plata-rapida-tarjeta-cmr', title: 'Plata Rápida con Tarjeta CMR | DolarExpress', description: 'Plata rápida usando el cupo de tu CMR Falabella. Proceso express por WhatsApp, transferencia en menos de 15 minutos. Sin papeleos, sin DICOM, sin banco.' },
  { slug: 'plata-rapida-tarjeta-paris', title: 'Plata Rápida con Tarjeta Paris | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Paris en plata rápida. Proceso express, transferencia en 15 minutos. Operamos todos los días, feriados incluidos. Sin trámites.' },
  { slug: 'plata-rapida-tarjeta-la-polar', title: 'Plata Rápida con Tarjeta La Polar | DolarExpress', description: 'Tu cupo La Polar es plata rápida disponible. DolarExpress hace la conversión en 15 minutos. Sin avance, sin DICOM, sin garante. Solo WhatsApp y listo.' },
  { slug: 'plata-rapida-tarjeta-hites', title: 'Plata Rápida con Tarjeta Hites | DolarExpress', description: 'Obtenés plata rápida con el cupo de tu Tarjeta Hites. Proceso express por WhatsApp, transferencia en menos de 15 minutos. Sin banco, sin DICOM.' },
  { slug: 'plata-rapida-tarjeta-cencosud', title: 'Plata Rápida con Tarjeta Cencosud | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Cencosud en plata rápida. DolarExpress hace la transferencia en 15 minutos. Sin avance necesario, sin DICOM, sin papeleos.' },
  { slug: 'plata-rapida-tarjeta-abcdin', title: 'Plata Rápida con Tarjeta ABCDin | DolarExpress', description: 'Tu cupo ABCDin puede ser plata rápida hoy. DolarExpress convierte ese cupo en efectivo en 15 minutos por WhatsApp. Sin avance, sin DICOM, sin trámites.' },
  { slug: 'efectivo-urgente-tarjeta-de-tienda', title: 'Efectivo Urgente con Tarjeta de Tienda | DolarExpress', description: 'Necesitás efectivo urgente y tenés tarjeta de grandes tiendas con cupo? DolarExpress te transfiere en 15 minutos. Sin DICOM, sin banco. Solo WhatsApp.' },
  { slug: 'efectivo-urgente-tarjeta-lider', title: 'Efectivo Urgente con Tarjeta Líder | DolarExpress', description: 'Efectivo urgente usando el cupo de tu Tarjeta Líder. Proceso express por WhatsApp, transferencia en menos de 15 minutos. Sin avance, sin DICOM, sin banco.' },
  { slug: 'efectivo-urgente-tarjeta-cmr', title: 'Efectivo Urgente con Tarjeta CMR | DolarExpress', description: 'Obtenés efectivo urgente con el cupo de tu CMR Falabella. DolarExpress hace la transferencia en 15 minutos. Operamos los 7 días de la semana, sin trámites.' },
  { slug: 'efectivo-urgente-tarjeta-ripley', title: 'Efectivo Urgente con Tarjeta Ripley | DolarExpress', description: 'Tu Tarjeta Ripley con cupo es tu acceso a efectivo urgente. DolarExpress te transfiere en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM.' },
  { slug: 'efectivo-urgente-tarjeta-paris', title: 'Efectivo Urgente con Tarjeta Paris | DolarExpress', description: 'Efectivo urgente usando el cupo de tu Tarjeta Paris. Proceso express, transferencia en 15 minutos. Sin avance requerido, sin DICOM, sin papeleos. 7 días.' },
  { slug: 'efectivo-urgente-tarjeta-la-polar', title: 'Efectivo Urgente con Tarjeta La Polar | DolarExpress', description: 'Necesitás efectivo urgente y tenés Tarjeta La Polar con cupo? DolarExpress te transfiere en 15 minutos. Sin avance, sin DICOM, sin garante. Solo WhatsApp.' },
  { slug: 'efectivo-hoy-tarjeta-retail', title: 'Efectivo Hoy con Tarjeta Retail | DolarExpress', description: 'Convertí el cupo de tu tarjeta retail en efectivo hoy mismo. Cualquier tarjeta de grandes tiendas: CMR, Ripley, Paris, La Polar, Hites y más. En 15 minutos.' },
  { slug: 'efectivo-mismo-dia-tarjeta-lider', title: 'Efectivo el Mismo Día con Tarjeta Líder | DolarExpress', description: 'Recibís efectivo el mismo día usando el cupo de tu Tarjeta Líder. DolarExpress hace la transferencia en 15 minutos. Sin avance, sin DICOM, sin papeleos.' },
  { slug: 'efectivo-mismo-dia-tarjeta-cmr', title: 'Efectivo el Mismo Día con Tarjeta CMR | DolarExpress', description: 'Convertí el cupo de tu CMR Falabella en efectivo el mismo día. Proceso express por WhatsApp, transferencia en 15 minutos. Sin avance habilitado, sin DICOM.' },
  { slug: 'efectivo-mismo-dia-tarjeta-ripley', title: 'Efectivo el Mismo Día con Tarjeta Ripley | DolarExpress', description: 'Recibís efectivo el mismo día con el cupo de tu Tarjeta Ripley. DolarExpress transfiere en 15 minutos. Sin avance, sin DICOM, sin documentos. Solo WhatsApp.' },
  { slug: 'efectivo-mismo-dia-tarjeta-paris', title: 'Efectivo el Mismo Día con Tarjeta Paris | DolarExpress', description: 'Efectivo el mismo día usando el cupo de tu Tarjeta Paris. DolarExpress hace la transferencia en 15 minutos. Sin avance requerido, sin DICOM, sin papeleos.' },

  // === CLUSTER 8: AVANCE ===
  { slug: 'avance-efectivo-tarjeta-cencosud', title: 'Avance Efectivo Tarjeta Cencosud | DolarExpress', description: 'No tenés avance habilitado en tu Tarjeta Cencosud? DolarExpress usa tu cupo de compras para darte efectivo igual. Sin avance, sin DICOM. Transferencia en 15 min.' },
  { slug: 'avance-efectivo-tarjeta-corona', title: 'Avance Efectivo Tarjeta Corona | DolarExpress', description: 'Alternativa al avance para tu Tarjeta Corona. DolarExpress convierte tu cupo de compras en efectivo sin necesitar avance habilitado. Transferencia en 15 minutos.' },
  { slug: 'avance-efectivo-tarjeta-johnson', title: 'Avance Efectivo Tarjeta Johnson | DolarExpress', description: 'Sin avance en tu Tarjeta Johnson? DolarExpress usa tu cupo de compras para darte efectivo al instante. Sin habilitaciones, sin DICOM. Transferencia en 15 min.' },
  { slug: 'avance-tarjeta-lider-sin-habilitacion', title: 'Avance Tarjeta Líder Sin Habilitación | DolarExpress', description: 'Obtenés efectivo de tu Tarjeta Líder sin necesitar avance habilitado. DolarExpress usa tu cupo de compras. Proceso por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'avance-tarjeta-cmr-sin-habilitacion', title: 'Avance Tarjeta CMR Sin Habilitación | DolarExpress', description: 'Efectivo de tu CMR Falabella sin avance habilitado. DolarExpress convierte tu cupo de compras en pesos chilenos. Sin habilitaciones, sin DICOM. En 15 minutos.' },
  { slug: 'avance-tarjeta-ripley-sin-habilitacion', title: 'Avance Tarjeta Ripley Sin Habilitación | DolarExpress', description: 'Obtenés efectivo de tu Tarjeta Ripley sin avance habilitado. DolarExpress usa el cupo de compras para darte efectivo al instante. Transferencia en 15 minutos.' },
  { slug: 'avance-tarjeta-paris-sin-habilitacion', title: 'Avance Tarjeta Paris Sin Habilitación | DolarExpress', description: 'Sin avance habilitado en tu Tarjeta Paris? DolarExpress convierte tu cupo de compras en efectivo. Sin habilitaciones especiales. Proceso por WhatsApp, en 15 min.' },
  { slug: 'alternativa-avance-efectivo-tarjeta-retail', title: 'Alternativa al Avance Efectivo con Tarjeta Retail | DolarExpress', description: 'La alternativa real al avance en efectivo para tarjetas retail. DolarExpress convierte tu cupo de compras en efectivo sin necesitar avance. En 15 minutos.' },
  { slug: 'alternativa-avance-cmr', title: 'Alternativa al Avance CMR Falabella | DolarExpress', description: 'No tenés avance en tu CMR? DolarExpress es la alternativa. Usamos tu cupo de compras para darte efectivo sin avance habilitado. Transferencia en 15 minutos.' },
  { slug: 'alternativa-avance-ripley', title: 'Alternativa al Avance Ripley | DolarExpress', description: 'La mejor alternativa al avance Ripley. DolarExpress convierte el cupo de compras de tu Tarjeta Ripley en efectivo. Sin avance necesario. En 15 minutos.' },
  { slug: 'alternativa-avance-lider', title: 'Alternativa al Avance Tarjeta Líder | DolarExpress', description: 'Sin avance habilitado en tu Tarjeta Líder? DolarExpress es la alternativa. Usamos tu cupo de compras para darte efectivo al instante. Transferencia en 15 min.' },
  { slug: 'alternativa-avance-paris', title: 'Alternativa al Avance Paris Cencosud | DolarExpress', description: 'La alternativa real al avance Paris. DolarExpress convierte el cupo de compras de tu Tarjeta Paris en efectivo. Sin avance, sin DICOM. Transferencia en 15 min.' },
  { slug: 'alternativa-avance-la-polar', title: 'Alternativa al Avance La Polar | DolarExpress', description: 'Sin avance en tu Tarjeta La Polar? DolarExpress es la solución. Usamos tu cupo de compras para darte efectivo sin necesitar avance habilitado. En 15 minutos.' },
  { slug: 'sin-avance-habilitado-lider-igual-obtengo-plata', title: 'Sin Avance Habilitado en Líder Igual Obtenés Plata | DolarExpress', description: 'No importa que no tengas avance habilitado en tu Tarjeta Líder. DolarExpress usa tu cupo de compras para darte efectivo igual. Solo WhatsApp. En 15 minutos.' },
  { slug: 'sin-avance-habilitado-cmr-igual-obtengo-plata', title: 'Sin Avance Habilitado en CMR Igual Obtenés Plata | DolarExpress', description: 'Sin avance habilitado en tu CMR Falabella? Igual podés obtener plata con DolarExpress. Usamos tu cupo de compras. Sin habilitaciones. Transferencia en 15 min.' },

  // === CLUSTER 9: TRANSFERIR / PASAR CUPO ===
  { slug: 'transferir-cupo-lider-a-cuenta', title: 'Transferir Cupo Líder a Cuenta Bancaria | DolarExpress', description: 'DolarExpress transfiere el valor de tu cupo Líder directamente a tu cuenta bancaria. Sin avance, sin banco. Proceso por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'transferir-cupo-ripley-a-cuenta', title: 'Transferir Cupo Ripley a Cuenta Bancaria | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Ripley en transferencia bancaria. DolarExpress hace el proceso en 15 minutos. Sin avance habilitado, sin DICOM, sin papeleos.' },
  { slug: 'transferir-cupo-paris-a-cuenta', title: 'Transferir Cupo Paris a Cuenta Bancaria | DolarExpress', description: 'DolarExpress convierte el cupo de tu Tarjeta Paris en una transferencia bancaria. En 15 minutos. Sin avance, sin DICOM, sin documentos adicionales.' },
  { slug: 'transferir-cupo-la-polar-a-cuenta', title: 'Transferir Cupo La Polar a Cuenta Bancaria | DolarExpress', description: 'Transformá el cupo de tu Tarjeta La Polar en una transferencia a tu cuenta. DolarExpress lo hace en 15 minutos por WhatsApp. Sin avance, sin DICOM.' },
  { slug: 'transferir-cupo-hites-a-cuenta', title: 'Transferir Cupo Hites a Cuenta Bancaria | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Hites en efectivo en tu cuenta bancaria. DolarExpress hace el proceso en 15 minutos. Sin avance habilitado, sin DICOM.' },
  { slug: 'transferir-cupo-abcdin-a-cuenta', title: 'Transferir Cupo ABCDin a Cuenta Bancaria | DolarExpress', description: 'DolarExpress convierte el cupo de tu Tarjeta ABCDin en transferencia bancaria. Sin avance, sin DICOM. Proceso por WhatsApp, dinero en tu cuenta en 15 minutos.' },
  { slug: 'pasar-cupo-lider-a-efectivo', title: 'Pasar Cupo Líder a Efectivo | DolarExpress', description: 'Pasá el cupo de tu Tarjeta Líder a efectivo en tu cuenta bancaria. DolarExpress hace el proceso en 15 minutos. Sin avance, sin DICOM, sin papeleos. Solo WhatsApp.' },
  { slug: 'pasar-cupo-cmr-a-efectivo', title: 'Pasar Cupo CMR a Efectivo | DolarExpress', description: 'Convertí el cupo de tu CMR Falabella en efectivo en minutos. DolarExpress transfiere a tu cuenta bancaria o CuentaRUT. Sin avance, sin DICOM. En 15 minutos.' },
  { slug: 'pasar-cupo-ripley-a-efectivo', title: 'Pasar Cupo Ripley a Efectivo | DolarExpress', description: 'Pasá el cupo de tu Tarjeta Ripley a efectivo en tu cuenta. DolarExpress hace la transferencia en 15 minutos. Sin avance habilitado, sin DICOM, sin trámites.' },
  { slug: 'pasar-cupo-paris-a-efectivo', title: 'Pasar Cupo Paris a Efectivo | DolarExpress', description: 'DolarExpress convierte el cupo de tu Tarjeta Paris en efectivo. Transferencia a tu cuenta bancaria en 15 minutos. Sin avance, sin DICOM, sin documentos.' },
  { slug: 'pasar-cupo-la-polar-a-efectivo', title: 'Pasar Cupo La Polar a Efectivo | DolarExpress', description: 'Pasá el cupo de tu Tarjeta La Polar a efectivo hoy. DolarExpress transfiere en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM, sin banco.' },
  { slug: 'pasar-cupo-hites-a-efectivo', title: 'Pasar Cupo Hites a Efectivo | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Hites en efectivo en tu cuenta. DolarExpress hace el proceso en 15 minutos. Sin avance, sin DICOM, sin papeleos. Solo WhatsApp.' },
  { slug: 'pasar-cupo-cencosud-a-efectivo', title: 'Pasar Cupo Cencosud a Efectivo | DolarExpress', description: 'DolarExpress convierte el cupo de tu Tarjeta Cencosud en efectivo. Transferencia en 15 minutos. Sin avance habilitado, sin DICOM, sin documentos adicionales.' },

  // === CLUSTER 10: VENDER CUPO POR MARCA ===
  { slug: 'vender-cupo-la-polar', title: 'Vender Cupo La Polar | DolarExpress', description: 'Vendé el cupo de tu Tarjeta La Polar y recibí efectivo hoy. DolarExpress paga al instante vía transferencia bancaria. Sin DICOM, sin papeleos, 7 días a la semana.' },
  { slug: 'vender-cupo-hites', title: 'Vender Cupo Hites | DolarExpress', description: 'Vendé el cupo de tu Tarjeta Hites en efectivo hoy mismo. DolarExpress te transfiere en 15 minutos. Sin avance, sin DICOM, sin documentos. Solo WhatsApp.' },
  { slug: 'vender-cupo-paris', title: 'Vender Cupo Paris | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Paris en efectivo vendiéndolo a DolarExpress. Proceso simple por WhatsApp, transferencia en 15 minutos. Sin DICOM ni papeleos.' },
  { slug: 'vender-cupo-lider', title: 'Vender Cupo Líder | DolarExpress', description: 'Vendé el cupo de tu Tarjeta Líder y recibí efectivo al instante. DolarExpress paga en 15 minutos vía transferencia. Sin avance, sin DICOM, sin burocracia.' },
  { slug: 'vender-cupo-cencosud', title: 'Vender Cupo Cencosud | DolarExpress', description: 'Vendé el cupo de tu Tarjeta Cencosud hoy. DolarExpress te transfiere el efectivo en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM, sin papeleos.' },
  { slug: 'vender-cupo-corona', title: 'Vender Cupo Corona | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Corona en efectivo vendiéndolo a DolarExpress. Proceso rápido por WhatsApp, transferencia en 15 minutos. Sin DICOM ni documentos.' },
  { slug: 'vender-cupo-johnson', title: 'Vender Cupo Johnson | DolarExpress', description: 'Vendé el cupo de tu Tarjeta Johnson y recibí efectivo hoy. DolarExpress paga en 15 minutos vía transferencia bancaria. Sin avance, sin DICOM, sin trámites.' },
  { slug: 'vender-cupo-abcdin', title: 'Vender Cupo ABCDin | DolarExpress', description: 'Convertí el cupo de tu Tarjeta ABCDin en efectivo hoy mismo. DolarExpress te transfiere en 15 minutos por WhatsApp. Sin avance, sin DICOM, sin papeleos.' },

  // === CLUSTER 11: LIQUIDAR CUPO ===
  { slug: 'liquidar-cupo-lider-online', title: 'Liquidar Cupo Líder Online | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta Líder 100% online. Sin ir a sucursales, sin filas. DolarExpress hace la transferencia en 15 minutos por WhatsApp. Sin DICOM.' },
  { slug: 'liquidar-cupo-ripley-online', title: 'Liquidar Cupo Ripley Online | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta Ripley de forma 100% online. DolarExpress hace el proceso por WhatsApp, transferencia en 15 minutos. Sin avance, sin DICOM.' },
  { slug: 'liquidar-cupo-paris-online', title: 'Liquidar Cupo Paris Online | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta Paris completamente online. Sin sucursales ni documentos físicos. DolarExpress transfiere en 15 minutos por WhatsApp. Sin DICOM.' },
  { slug: 'liquidar-cupo-la-polar', title: 'Liquidar Cupo La Polar | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta La Polar y recibí efectivo hoy. DolarExpress convierte tu cupo en pesos en 15 minutos. Sin avance, sin DICOM, sin papeleos.' },
  { slug: 'liquidar-cupo-la-polar-online', title: 'Liquidar Cupo La Polar Online | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta La Polar 100% online por WhatsApp. DolarExpress transfiere en 15 minutos. Sin ir a ningún lado, sin avance, sin DICOM.' },
  { slug: 'liquidar-cupo-cencosud', title: 'Liquidar Cupo Cencosud | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta Cencosud hoy mismo. DolarExpress convierte tu cupo en efectivo en 15 minutos. Sin avance habilitado, sin DICOM, sin papeleos.' },
  { slug: 'liquidar-cupo-corona', title: 'Liquidar Cupo Corona | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta Corona y recibí efectivo al instante. DolarExpress hace el proceso en 15 minutos por WhatsApp. Sin avance, sin DICOM.' },
  { slug: 'liquidar-cupo-johnson', title: 'Liquidar Cupo Johnson | DolarExpress', description: 'Liquidá el cupo de tu Tarjeta Johnson hoy. DolarExpress convierte tu cupo en pesos chilenos en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM.' },

  // === CLUSTER 12: DINERO / EFECTIVO ===
  { slug: 'dinero-rapido-con-tarjeta-retail', title: 'Dinero Rápido con Tarjeta Retail | DolarExpress', description: 'El dinero más rápido del mercado usando el cupo de tu tarjeta retail. CMR, Ripley, Paris, La Polar, Líder, Hites y más. Sin DICOM, sin banco. En 15 minutos.' },
  { slug: 'dinero-urgente-con-tarjeta-de-tienda', title: 'Dinero Urgente con Tarjeta de Tienda | DolarExpress', description: 'Necesitás dinero urgente y tenés tarjeta de grandes tiendas con cupo? DolarExpress te transfiere en 15 minutos. Sin avance, sin DICOM. Solo WhatsApp.' },
  { slug: 'dinero-en-efectivo-tarjeta-lider', title: 'Dinero en Efectivo con Tarjeta Líder | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Líder en dinero efectivo hoy. DolarExpress hace el proceso en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM.' },
  { slug: 'dinero-en-efectivo-tarjeta-cmr', title: 'Dinero en Efectivo con Tarjeta CMR | DolarExpress', description: 'Obtenés dinero en efectivo con el cupo de tu CMR Falabella. DolarExpress transfiere en 15 minutos. Sin avance, sin DICOM, sin liquidaciones. Solo WhatsApp.' },
  { slug: 'dinero-en-efectivo-tarjeta-ripley', title: 'Dinero en Efectivo con Tarjeta Ripley | DolarExpress', description: 'Tu Tarjeta Ripley puede ser dinero en efectivo hoy. DolarExpress convierte el cupo en pesos en 15 minutos. Sin avance habilitado, sin DICOM, sin papeleos.' },
  { slug: 'dinero-en-efectivo-tarjeta-paris', title: 'Dinero en Efectivo con Tarjeta Paris | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Paris en dinero efectivo. DolarExpress hace el proceso en 15 minutos por WhatsApp. Sin avance, sin DICOM, sin documentos.' },
  { slug: 'dinero-en-efectivo-tarjeta-la-polar', title: 'Dinero en Efectivo con Tarjeta La Polar | DolarExpress', description: 'Obtenés dinero en efectivo con el cupo de tu Tarjeta La Polar. DolarExpress transfiere en 15 minutos. Sin avance habilitado, sin DICOM, sin garante.' },
  { slug: 'convertir-cupo-lider-efectivo', title: 'Convertir Cupo Líder a Efectivo | DolarExpress', description: 'Convertí el cupo de compras de tu Tarjeta Líder en efectivo hoy. DolarExpress hace la conversión en 15 minutos. Sin avance, sin DICOM. Proceso 100% online.' },
  { slug: 'convertir-cupo-paris-efectivo', title: 'Convertir Cupo Paris a Efectivo | DolarExpress', description: 'Transformá el cupo de tu Tarjeta Paris en efectivo hoy mismo. DolarExpress hace la conversión en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM.' },
  { slug: 'convertir-cupo-la-polar-efectivo', title: 'Convertir Cupo La Polar a Efectivo | DolarExpress', description: 'Convertí el cupo de tu Tarjeta La Polar en efectivo al instante. DolarExpress transfiere en 15 minutos. Sin avance, sin DICOM, sin documentos. Solo WhatsApp.' },
  { slug: 'convertir-cupo-hites-efectivo', title: 'Convertir Cupo Hites a Efectivo | DolarExpress', description: 'Transformá el cupo de tu Tarjeta Hites en efectivo hoy. DolarExpress hace la conversión en 15 minutos por WhatsApp. Sin avance habilitado, sin DICOM.' },
  { slug: 'convertir-cupo-cencosud-efectivo', title: 'Convertir Cupo Cencosud a Efectivo | DolarExpress', description: 'Convertí el cupo de tu Tarjeta Cencosud en efectivo al instante. DolarExpress transfiere en 15 minutos. Sin avance, sin DICOM, sin papeleos. Solo WhatsApp.' },
  { slug: 'convertir-cupo-abcdin-efectivo', title: 'Convertir Cupo ABCDin a Efectivo | DolarExpress', description: 'Transformá el cupo de tu Tarjeta ABCDin en efectivo hoy mismo. DolarExpress hace la conversión en 15 minutos por WhatsApp. Sin avance, sin DICOM.' },

  // === CLUSTER DICOM: GENÉRICOS ===
  { slug: 'prestamo-con-dicom', title: 'Préstamo con DICOM | DolarExpress', description: 'Estás en DICOM y necesitás efectivo? DolarExpress trabaja con personas en DICOM que tengan tarjeta de grandes tiendas con cupo. Sin revisar historial. En 15 min.' },
  { slug: 'prestamo-con-dicom-tarjeta-de-tienda', title: 'Préstamo con DICOM y Tarjeta de Tienda | DolarExpress', description: 'Estás en DICOM pero tenés tarjeta de grandes tiendas con cupo? DolarExpress te da efectivo igual. Sin evaluación crediticia. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-dicom-tarjeta-retail', title: 'Préstamo con DICOM usando Tarjeta Retail | DolarExpress', description: 'Tu tarjeta retail con cupo es tu acceso a efectivo aunque estés en DICOM. DolarExpress no revisa historial. CMR, Ripley, La Polar, Hites y más. En 15 minutos.' },
  { slug: 'prestamo-con-dicom-solo-con-tarjeta', title: 'Préstamo con DICOM Solo con Tarjeta de Tienda | DolarExpress', description: 'Solo necesitás tu tarjeta de grandes tiendas con cupo para obtener efectivo aunque estés en DICOM. DolarExpress no evalúa historial. Transferencia en 15 min.' },
  { slug: 'prestamo-con-dicom-online', title: 'Préstamo con DICOM Online | DolarExpress', description: 'Obtenés préstamo aunque estés en DICOM, 100% online. DolarExpress usa el cupo de tu tarjeta retail. Sin ir a sucursales, sin DICOM check. Transferencia en 15 min.' },
  { slug: 'prestamo-con-dicom-urgente', title: 'Préstamo con DICOM Urgente | DolarExpress', description: 'Estás en DICOM y necesitás efectivo urgente? DolarExpress tiene la solución. Solo necesitás tarjeta de tienda con cupo. Transferencia en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-con-dicom-rapido', title: 'Préstamo con DICOM Rápido | DolarExpress', description: 'Préstamo rápido aunque estés en DICOM. DolarExpress no revisa tu historial crediticio. Solo cupo en tarjeta retail. Proceso express, transferencia en 15 minutos.' },
  { slug: 'credito-con-dicom', title: 'Crédito con DICOM | DolarExpress', description: 'Accedés a crédito aunque estés en DICOM. DolarExpress usa el cupo de tu tarjeta de grandes tiendas. Sin evaluación crediticia, sin banco. Efectivo en 15 minutos.' },
  { slug: 'credito-con-dicom-tarjeta-de-tienda', title: 'Crédito con DICOM usando Tarjeta de Tienda | DolarExpress', description: 'Tu tarjeta de tienda con cupo es acceso a crédito aunque tengas DICOM. DolarExpress no revisa historial. CMR, Ripley, La Polar y más. Efectivo en 15 minutos.' },
  { slug: 'credito-con-dicom-online', title: 'Crédito con DICOM Online | DolarExpress', description: 'Crédito online aunque estés en DICOM. DolarExpress usa el cupo de tu tarjeta retail. Sin ir a ningún lado, sin historial crediticio. Transferencia en 15 minutos.' },
  { slug: 'credito-con-dicom-urgente', title: 'Crédito con DICOM Urgente | DolarExpress', description: 'Crédito urgente para personas en DICOM. DolarExpress convierte el cupo de tu tarjeta retail en efectivo en 15 minutos. Sin evaluación bancaria, sin rechazo.' },
  { slug: 'efectivo-con-dicom-tarjeta-de-tienda', title: 'Efectivo con DICOM y Tarjeta de Tienda | DolarExpress', description: 'Obtenés efectivo aunque estés en DICOM si tenés tarjeta de grandes tiendas con cupo. DolarExpress no revisa historial. Transferencia en 15 minutos por WhatsApp.' },
  { slug: 'plata-con-dicom-tarjeta-retail', title: 'Plata con DICOM usando Tarjeta Retail | DolarExpress', description: 'Tu tarjeta retail con cupo te da acceso a plata aunque estés en DICOM. DolarExpress convierte ese cupo en efectivo en 15 minutos. Sin evaluación crediticia.' },

  // === CLUSTER DICOM: POR MARCA ===
  { slug: 'prestamo-con-dicom-tarjeta-lider', title: 'Préstamo con DICOM Tarjeta Líder | DolarExpress', description: 'Estás en DICOM y tenés Tarjeta Líder con cupo? DolarExpress te da efectivo sin revisar tu historial. Solo cupo disponible. Transferencia en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-con-dicom-tarjeta-cmr', title: 'Préstamo con DICOM Tarjeta CMR | DolarExpress', description: 'Tenés CMR Falabella y estás en DICOM? DolarExpress convierte tu cupo en efectivo sin evaluar tu historial crediticio. Proceso por WhatsApp, en 15 minutos.' },
  { slug: 'prestamo-con-dicom-tarjeta-ripley', title: 'Préstamo con DICOM Tarjeta Ripley | DolarExpress', description: 'Tarjeta Ripley con cupo y DICOM? DolarExpress te da efectivo igual. Sin revisar historial, sin banco. Proceso 100% online por WhatsApp, transferencia en 15 min.' },
  { slug: 'prestamo-con-dicom-tarjeta-paris', title: 'Préstamo con DICOM Tarjeta Paris | DolarExpress', description: 'Estás en DICOM y tenés Tarjeta Paris con cupo? DolarExpress no revisa tu historial. Convertimos tu cupo en efectivo en 15 minutos. Solo necesitás WhatsApp.' },
  { slug: 'prestamo-con-dicom-tarjeta-la-polar', title: 'Préstamo con DICOM Tarjeta La Polar | DolarExpress', description: 'Tarjeta La Polar con cupo y estás en DICOM? DolarExpress tiene la solución. Sin evaluar historial crediticio. Efectivo en tu cuenta en 15 minutos por WhatsApp.' },
  { slug: 'prestamo-con-dicom-tarjeta-hites', title: 'Préstamo con DICOM Tarjeta Hites | DolarExpress', description: 'Tenés Tarjeta Hites y estás en DICOM? DolarExpress convierte tu cupo en efectivo sin revisar historial. Proceso express por WhatsApp, transferencia en 15 minutos.' },
  { slug: 'prestamo-con-dicom-tarjeta-cencosud', title: 'Préstamo con DICOM Tarjeta Cencosud | DolarExpress', description: 'Tarjeta Cencosud con cupo y DICOM? DolarExpress te da efectivo sin evaluar tu historial crediticio. Solo cupo disponible. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-dicom-tarjeta-abcdin', title: 'Préstamo con DICOM Tarjeta ABCDin | DolarExpress', description: 'Estás en DICOM y tenés Tarjeta ABCDin con cupo? DolarExpress convierte ese cupo en efectivo sin revisar historial. Proceso por WhatsApp, en 15 minutos.' },
  { slug: 'credito-con-dicom-tarjeta-lider', title: 'Crédito con DICOM Tarjeta Líder | DolarExpress', description: 'Crédito informal para personas en DICOM con Tarjeta Líder. DolarExpress usa tu cupo de compras sin evaluar historial crediticio. Efectivo en 15 minutos.' },
  { slug: 'credito-con-dicom-tarjeta-cmr', title: 'Crédito con DICOM Tarjeta CMR | DolarExpress', description: 'Accedés a crédito aunque estés en DICOM si tenés CMR Falabella con cupo. DolarExpress convierte ese cupo en efectivo sin banco. Transferencia en 15 minutos.' },
  { slug: 'credito-con-dicom-tarjeta-ripley', title: 'Crédito con DICOM Tarjeta Ripley | DolarExpress', description: 'Tarjeta Ripley con cupo es acceso a crédito aunque tengas DICOM. DolarExpress no revisa historial. Proceso 100% online por WhatsApp, efectivo en 15 minutos.' },
  { slug: 'credito-con-dicom-tarjeta-paris', title: 'Crédito con DICOM Tarjeta Paris | DolarExpress', description: 'Crédito informal con Tarjeta Paris para personas en DICOM. DolarExpress usa tu cupo sin evaluar historial crediticio. Efectivo en tu cuenta en 15 minutos.' },

  // === CLUSTER DICOM: SITUACIÓN DEL USUARIO ===
  { slug: 'estoy-en-dicom-y-necesito-plata', title: 'Estoy en DICOM y Necesito Plata | DolarExpress', description: 'Estás en DICOM y necesitás plata? Si tenés tarjeta de grandes tiendas con cupo, DolarExpress tiene la solución. Sin revisar historial. Transferencia en 15 min.' },
  { slug: 'estoy-en-dicom-y-tengo-cupo-en-tarjeta', title: 'Estoy en DICOM y Tengo Cupo en Tarjeta | DolarExpress', description: 'Estás en DICOM pero tenés cupo en tu tarjeta de tienda? Ese cupo es efectivo disponible hoy con DolarExpress. Sin evaluar historial. Transferencia en 15 min.' },
  { slug: 'estoy-en-dicom-y-tengo-cupo-lider', title: 'Estoy en DICOM y Tengo Cupo en Tarjeta Líder | DolarExpress', description: 'DICOM + cupo en Tarjeta Líder = solución con DolarExpress. Sin revisar historial crediticio. Convertimos tu cupo en efectivo en 15 minutos por WhatsApp.' },
  { slug: 'estoy-en-dicom-y-tengo-cupo-cmr', title: 'Estoy en DICOM y Tengo Cupo en CMR | DolarExpress', description: 'Tenés CMR Falabella con cupo y estás en DICOM? DolarExpress convierte ese cupo en efectivo sin evaluar historial. Proceso por WhatsApp, transferencia en 15 min.' },
  { slug: 'estoy-en-dicom-y-tengo-cupo-ripley', title: 'Estoy en DICOM y Tengo Cupo en Ripley | DolarExpress', description: 'DICOM + cupo en Tarjeta Ripley? DolarExpress tiene la solución. Convertimos tu cupo en efectivo sin revisar historial crediticio. Transferencia en 15 minutos.' },
  { slug: 'estoy-en-dicom-y-tengo-cupo-paris', title: 'Estoy en DICOM y Tengo Cupo en Paris | DolarExpress', description: 'Tenés Tarjeta Paris con cupo y estás en DICOM? DolarExpress no revisa historial. Convertimos tu cupo en efectivo en 15 minutos. Solo necesitás WhatsApp.' },
  { slug: 'estoy-en-dicom-necesito-prestamo-urgente', title: 'Estoy en DICOM y Necesito Préstamo Urgente | DolarExpress', description: 'DICOM + urgencia? DolarExpress es la solución. Si tenés tarjeta de tienda con cupo, te damos efectivo sin revisar historial. Transferencia en 15 minutos.' },
  { slug: 'tengo-dicom-y-necesito-efectivo', title: 'Tengo DICOM y Necesito Efectivo | DolarExpress', description: 'Tenés DICOM y necesitás efectivo hoy? Si tenés tarjeta de grandes tiendas con cupo, DolarExpress convierte ese cupo en pesos sin evaluar historial. En 15 min.' },
  { slug: 'tengo-dicom-y-tengo-tarjeta-de-tienda', title: 'Tengo DICOM y Tengo Tarjeta de Tienda | DolarExpress', description: 'DICOM + tarjeta de tienda con cupo = solución real con DolarExpress. Sin revisar historial, sin banco. Efectivo en tu cuenta en 15 minutos por WhatsApp.' },
  { slug: 'tengo-dicom-y-tengo-cupo-disponible', title: 'Tengo DICOM y Tengo Cupo Disponible | DolarExpress', description: 'Tenés DICOM y cupo disponible en tu tarjeta retail? DolarExpress convierte ese cupo en efectivo hoy. Sin evaluar historial crediticio. Transferencia en 15 min.' },
  { slug: 'tengo-dicom-me-prestan-con-tarjeta', title: 'Tengo DICOM ¿Me Prestan con Tarjeta de Tienda? | DolarExpress', description: 'Sí. Aunque tengas DICOM, DolarExpress te da efectivo usando el cupo de tu tarjeta de grandes tiendas. Sin revisar historial. Solo cupo disponible. En 15 min.' },

  // === CLUSTER DICOM: MODIFICADORES ===
  { slug: 'prestamo-con-dicom-sin-aval', title: 'Préstamo con DICOM Sin Aval | DolarExpress', description: 'Estás en DICOM y necesitás efectivo sin aval? Solo tu tarjeta de tienda con cupo. DolarExpress no pide aval ni codeudor. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-dicom-sin-garante', title: 'Préstamo con DICOM Sin Garante | DolarExpress', description: 'Efectivo aunque estés en DICOM, sin necesitar garante. Solo cupo en tu tarjeta retail. DolarExpress no pide garantes ni fiadores. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-dicom-sin-cotizar', title: 'Préstamo con DICOM Sin Cotizaciones AFP | DolarExpress', description: 'Obtenés efectivo aunque estés en DICOM, sin cotizaciones AFP ni comprobantes de renta. Solo tu tarjeta de tienda con cupo. DolarExpress transfiere en 15 min.' },
  { slug: 'prestamo-con-dicom-sin-liquidaciones', title: 'Préstamo con DICOM Sin Liquidaciones | DolarExpress', description: 'Efectivo con DICOM sin presentar liquidaciones de sueldo. Solo cupo en tarjeta retail. DolarExpress no pide documentos laborales. Transferencia en 15 minutos.' },
  { slug: 'prestamo-con-dicom-sin-boleta', title: 'Préstamo con DICOM Sin Boleta de Honorarios | DolarExpress', description: 'Estás en DICOM y no tenés boletas de honorarios? Solo necesitás cupo en tu tarjeta de tienda. DolarExpress no pide comprobantes de ingresos. En 15 minutos.' },
  { slug: 'prestamo-con-dicom-sin-cuenta-corriente', title: 'Préstamo con DICOM Sin Cuenta Corriente | DolarExpress', description: 'Efectivo aunque estés en DICOM y no tengas cuenta corriente. DolarExpress transfiere a CuentaRUT también. Solo cupo en tarjeta retail. En 15 minutos.' },
  { slug: 'prestamo-con-dicom-al-instante', title: 'Préstamo con DICOM al Instante | DolarExpress', description: 'Efectivo al instante aunque estés en DICOM. DolarExpress procesa en menos de 15 minutos usando el cupo de tu tarjeta de tienda. Sin evaluar historial.' },
  { slug: 'prestamo-con-dicom-transferencia-inmediata', title: 'Préstamo con DICOM Transferencia Inmediata | DolarExpress', description: 'Transferencia inmediata aunque estés en DICOM. DolarExpress convierte el cupo de tu tarjeta retail en pesos en 15 minutos. Sin historial, sin banco.' },
  { slug: 'prestamo-con-dicom-mismo-dia', title: 'Préstamo con DICOM el Mismo Día | DolarExpress', description: 'Recibís el dinero el mismo día aunque estés en DICOM. DolarExpress usa el cupo de tu tarjeta de tienda. Sin evaluar historial crediticio. Transferencia en 15 min.' }
];
